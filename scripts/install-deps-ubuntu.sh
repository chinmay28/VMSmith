...
echo "=== vmSmith: Installing dependencies on Ubuntu ==="
...
echo "  # Ubuntu has no virtio-win apt package; download the signed ISO and point"
echo "  # storage.virtio_win_iso at it:"
echo "  curl -fsSL -o /var/lib/vmsmith/images/virtio-win.iso \\"
