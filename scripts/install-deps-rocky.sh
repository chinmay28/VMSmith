...
echo ""
echo "Optional — Windows guests (Windows 10/11, Server 2019/2022/2025):"
echo "  # Install the virtio-win driver ISO, then point storage.virtio_win_iso at it"
echo "  # (or leave it empty to auto-probe /usr/share/virtio-win/virtio-win.iso):"
echo "  dnf install -y virtio-win   # provides /usr/share/virtio-win/virtio-win.iso (needs the virtio-win repo)"
echo "  # See docs/WINDOWS_GUESTS.md for preparing a cloudbase-init base image."
