...
export const events = {
  list: ({ vmId = '', type = '', source = '', severity = '', resourceId = '', search = '', since = '', until = '', sort = '', order = '', page, perPage }: {
    vmId?: string;
    type?: string;
    ...
    unwrap(apiClient.GET('/events', {
      params: { query: { vm_id: vmId, type, source: source || undefined, severity: severity || undefined, resource_id: resourceId || undefined, search: search || undefined, since, until, sort: sort || undefined, order: order || undefined, page, per_page: perPage } as any },
    }), { withMeta: true }),
};
