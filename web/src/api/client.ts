...
export const images = {
  list: ({ page, perPage, tag = '', sourceVM = '', search = '', since = '', until = '', sort, order }: { page?: number; perPage?: number; tag?: string; sourceVM?: string; search?: string; since?: string; until?: string; sort?: string; order?: string } = {}) =>
    unwrap(apiClient.GET('/images', { params: { query: { page, per_page: perPage, tag: tag || undefined, source_vm: sourceVM || undefined, search: search || undefined, since: since || undefined, until: until || undefined, sort, order } } }), { withMeta: true }),
