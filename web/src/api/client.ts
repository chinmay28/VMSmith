...
export const schedules = {
  ...
  runs: (id: string, { page, perPage, status = '', vmId = '', since = '', until = '', finishedSince = '', finishedUntil = '', search = '', sort = '', order = '' }: { page?: number; perPage?: number; status?: 'running' | 'success' | 'error' | 'skipped' | ''; vmId?: string; since?: string; until?: string; finishedSince?: string; finishedUntil?: string; search?: string; sort?: 'id' | 'started_at' | 'finished_at' | 'status' | ''; order?: 'asc' | 'desc' | '' } = {}) =>
