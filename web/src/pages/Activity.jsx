...
export default function Activity({ vmId: vmIdProp = '', embedded = false } = {}) {
  ...
  const initial = useURL
    ...
    : { vmId: vmIdProp, type: '', typePrefix: '', source: '', severity: '', search: '', sort: '', order: '' };
  ...
  }, [useURL, vmFilter, typeFilter, typePrefixFilter, sourceFilter, severityFilter, searchFilter, sortField, sortOrder, setSearchParams]);
  ...
  }, [embedded, vmIdProp, vmFilter, typeFilter, typePrefixFilter, sourceFilter, severityFilter, searchFilter, sortField, sortOrder, page, perPage]);
  ...
  useEffect(() => {
    setPage(1);
  }, [vmFilter, typeFilter, typePrefixFilter, sourceFilter, severityFilter, searchFilter, sortField, sortOrder]);
    ...
    <div className="flex flex-col h-full">
      ...
      {!embedded && (
        <div className="flex flex-wrap items-center gap-2 mb-4">
          ...
          {(vmFilter || typeFilter || typePrefixInput || sourceFilter || severityFilter || searchInput || sortField || sortOrder) && (
            <button
              className="btn-ghost text-xs text-steel-400"
              onClick={() => { setVmFilter(''); setTypeFilter(''); setTypePrefixInput(''); setSourceFilter(''); setSeverityFilter(''); setSearchInput(''); setSortField(''); setSortOrder(''); }}
