...
| 4.1.11 | Docs: `docs/ARCHITECTURE.md` "Metrics" subsection (sampling, ring buffer, rate math, deferred persistence, Prometheus integration). Add to `docs/PRODUCTION_DEPLOYMENT.md` an example `prometheus.yml` scrape config | S | ✅ Done — `docs/ARCHITECTURE.md` documents the metrics pipeline/persistence tradeoffs, and `docs/PRODUCTION_DEPLOYMENT.md` includes a sample Prometheus scrape job |
