...
| # | Task | Effort | Notes |
|---|------|--------|-------|
| 6.3.1 | Write production deployment guide (systemd, TLS, reverse proxy, firewall rules) | M | **Done** — added `docs/DEPLOYMENT.md` with production-oriented config, systemd service, reverse proxy, firewall, logging, backup, and upgrade guidance |
