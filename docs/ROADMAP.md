...
| 2.1.7 | Add integration + E2E tests | M | ✅ Done — clone coverage now exists in `internal/api/api_test.go`, `internal/cli/commands_test.go`, `tests/web/gui.spec.js`, and `tests/e2e/test_api_vm_lifecycle.py` |
