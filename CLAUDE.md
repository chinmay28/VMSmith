...
│   │   ├── logs.go              # vmsmith logs list (HTTP client for the daemon's /api/v1/logs ring buffer; supports `--level --source --since --search --limit --page --fields`)
