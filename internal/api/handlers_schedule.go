...
func (s *Server) ListSchedules(w http.ResponseWriter, r *http.Request) {
	...
	if !types.IsValidScheduleSort(sortField) {
		writeErrorCode(w, http.StatusBadRequest, "invalid_sort", "sort must be one of: id, name, created_at, next_fire_at, last_fired_at, vm_id, action, timezone, enabled, catch_up_policy")
		return
	}
